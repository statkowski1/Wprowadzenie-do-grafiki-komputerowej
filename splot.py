                ...
                for i3 in range(0, image.shape[1]):
                    for i4 in range(0, kernel.shape[0]):
                        for i5 in range(0, kernel.shape[1]):
                            if((i2-((kernel.shape[0]-1)/2)+i4)>=0 and (i3-((kernel.shape[1]-1)/2)+i5)>=0 and (i2-((kernel.shape[0]-1)/2)+i4)<=(image.shape[0]-4) and (i3-((kernel.shape[1]-1)/2)+i5)<=(image.shape[2]-4)):
                                print('1 = '+str(i2-((kernel.shape[0]-1)/2)))
                                print('2 = '+str(i3-((kernel.shape[1]-1)/2)))
